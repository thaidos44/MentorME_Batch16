...
class Assets {
  ...
  static const AssetGenImage asset1 = AssetGenImage('assets/asset1.png');
  ...
  static const AssetGenImage password = AssetGenImage('assets/password.png');
  static const AssetGenImage user = AssetGenImage('assets/user.png');

  /// List of all assets
  static List<AssetGenImage> get values =>
      [asset1, email, github, google, linkedin, password, user];
}
